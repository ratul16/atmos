  ...
  <div class="container">
    <div class="head pt-4">
      <h1 class="text-uppercase font-weight-bold">
        ...
        <span class="appname">a</span>t<span class="appname">m</span>o<span
          class="appname"
          >s</span
        >
      </h1>
    ...
    <transition name="fade">
      <div class="weatherUpdate" v-if="show">
        <div
          class="card forcast rounded shadow my-4"
          :class="data.base.temp <= 20 ? 'cold' : ''"
        >
        ...
        <div class="country my-4">
          <div class="card rounded shadow border-0">
            <div class="card-body text-left text-capitalize">
              ...
              <h6>
                Geo Coords : [ {{ data.coord.lat }}, {{ data.coord.lon }} ]
              </h6>
              ...
              <div class="card rounded shadow">
                <div class="card-body font-weight-bold">
                  ...
                  <div class="text-right value">
                    <span
                      >{{ data.base.temp_min }}&#176;C |
                      {{ data.base.temp_max }}&#176;C</span
                    >
                  </div>
                </div>
              </div>
